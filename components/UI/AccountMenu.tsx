...
const AccountMenu: FC = () => {
  ...
  return (
    <div className='relative flex flex-col gap-y-2 items-start bg-[#141414] rounded-sm px-3 pt-2 pb-3 border-t border-white/70 shadow-xl accountMenuTriangle'>
      ...
      <Link href='/manage'>
        <a className='relative mt-1 cursor-pointer h-6 after:absolute after:w-48 after:-left-3 after:top-8 after:border-b after:border-b-[gray]/30 font-medium text-white text-end md:hover:underline'>
          Manage profiles
        </a>
      </Link>
      <Link href='/account'>
